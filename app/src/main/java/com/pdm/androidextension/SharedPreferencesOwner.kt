...
class SharedPreferencesOwner private constructor(context: Context) {
    ...
    // Function to save a developerToken value
    fun putToken(value: String) {
        sharedPreferences.edit().putString("Developer_Token", value).apply()
    }

    // Function to get a developerToken value
    fun getToken(): String? {
        return sharedPreferences.getString("Developer_Token", null)
    }

    // Function to save a developerToken time value
    fun putTokenTime(value: Long) {
        sharedPreferences.edit().putLong("Developer_Token_Time", value).apply()
    }

    // Function to get a developerToken time value
    fun getTokenTime(): Long {
        return sharedPreferences.getLong("Developer_Token_Time", 0)
    }
